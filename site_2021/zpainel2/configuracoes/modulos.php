...
$cAutomates->v_html_extra_admin = "<input type=\"button\" value=\"Voltar\" class=\"btn btn-secondary\" onclick=\"window.location='index.php';\">";
$cAutomates->v_html_extra_update = "<input type=\"button\" value=\"Itens\" class=\"btn btn-secondary\" onclick=\"window.location='modulos-itens.php?';\">";
$cAutomates->mAdmin();
?>