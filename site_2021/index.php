...
switch ($cUrl->mGetParam(1)) {
    ...
    **********************************/
    ...
    case "pacotes-e-passeios-personalizados":
        ...
        $cTpl->mSet("titulo", "Tour para Itaimbézinho");
    ...
    case "parques-nacionais":
        ...
        if ($cUrl->mGetParam(2)) {
            ...
            $cTpl->mSet("descricao", nl2br($parques[0]['ds_parques']));
            $cTpl->mShow("inicio");
    ...
    case "aparados-da-serra-turismo":
        ...
        if ($cUrl->mGetParam(2)) {
            ...
            $cTpl->mSet("descricao", nl2br($parques[0]['ds_turismo']));
            $cTpl->mShow("inicio");
    ...
    case "as-cidades":
        ...
        if ($cUrl->mGetParam(2)) {
            ...
            $cTpl->mSet("descricao", nl2br($cidades[0]['ds_cidades']));
    ...
    default:
        ...
        for ($i = 0; $i < count($informe); $i++) {
            ...
            $cTpl->mSet("link", "informe-se/" . $informe[$i]["cd_informe"] . "/" . $cUrl->mTrataString($informe[$i]["tt_informe"]));
            $cTpl->mSet("titulo", nl2br($informe[$i]["tt_informe"]));
