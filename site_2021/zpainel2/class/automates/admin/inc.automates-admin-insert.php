...
if ($_GET['dados']) {
	...
	// 		$fileJavascript.= "\t\t\t$('#file".$campos[$i]["field"]."').jqUploader({ 
	// 			url: '".$caminhoFotos."',

	// 			allowedExt:'".$realExtensoesFile."', 
	// 			allowedExtDescr: '".$realExtensoesFile."', 
	// 			nmArquivo: '".$campos[$i]["field"]."_".date("Y_m_d__H_i_s")."', 
	// 			nmCaminho: '".$this->v_caminho_imagem."' });\n";
	// 	}
	// }
